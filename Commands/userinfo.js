...
module.exports = {
    ...
    async execute(message,args,client){
        ...
        .setTimestamp()
            ...
            .addField("アカウント作成日時", moment(USER.createdAt).tz("Asia/Tokyo").format("YYYY年MM月DD日 h:mm A"), true)
            ...
            try{
              ...
              const DEFAULTROLE = await message.guild.roles.cache.get(message.guild.id)
                ...
                user_embed.addField("サーバー入室日時",moment(MEMBER.joinedAt).tz("Asia/Tokyo").format("YYYY年MM月DD日 h:mm A"),true)
            ...
            .addField("権限",MEMBER.permissions.toArray())
                ...
                user_embed.setFooter("指定されたユーザーはこのサーバーにいないため、サーバー入室日時、ロールの情報を表示できません。")
